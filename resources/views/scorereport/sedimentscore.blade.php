                        ...
                        <div class="col-md-12">
                          <div class="card table-card">
                            <div class="card-header">
                              <h3>แผนที่แสดงตำแหน่งฝายจำแนกตามปริมาณตะกอนหน้าฝาย ในพื้นที่จังหวัดเชียงใหม่</h3>                              
                                ...
                                <div class="card-block">
                                  <div class="row">
                                    <div class="col-lg-9 col-xl-12">
                                      <div class="sub-title"> <h4> ตารางสรุปผลจำนวนฝายจำแนกตามปริมาณตะกอนหน้าฝาย ในพื้นที่จังหวัดเชียงใหม่ </h4> </div>
                                    </div> 
                                  </div>
                                  <div id="tableData">
