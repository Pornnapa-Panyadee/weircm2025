...
<html lang="en">
  ...
  <body class="horizontal-icon-fixed" >
                        ...
                        <div class="col-md-12">
                          <div class="card table-card">
                            <div class="card-header">
                              <h3>แผนที่แสดงตำแหน่งฝายจำแนกตามสภาพฝาย ในพื้นที่จังหวัดเชียงใหม่</h3>                              
                                ...
                                <div class="card-block">
                                  <div class="row">
                                    <div class="col-lg-9 col-xl-12">
                                      <div class="sub-title"> <h4> ตารางสรุปผลจำนวนฝายจำแนกตามสภาพฝาย ในพื้นที่จังหวัดเชียงใหม่ </h4> </div>
                                    </div> 
                                  </div>
                                  <div id="tableData">
    ...
    <script type="text/javascript">
      ...
      var runLayer = omnivore.kml('{{ asset('kml/CM_bound-25-amp.kml') }}')
        .on('ready', function() {
            this.setStyle({
                      fillOpacity: 0,
              color: "#466DF3",
     ...
     var amp = [
      ...
      if(mx.matches){
        ...
        addPin(station14,13,"1",mo);
        addPin(station15,14,"1",mo);
        ...
        addPin(station32,13,"2",mo);
        addPin(station33,14,"2",mo);
        ...
        addPin(station50,13,"3",mo);
        addPin(station51,14,"3",mo);
