    ...
    <body>
     <div class="pcoded-content">
        <table>
            <tr>
                <td width="15%">
                    <img src="images/footer/cm.png" width="80%">
                </td>
                <td width="70%">
                    ...
                    <div class="text2">โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝายและการบริหารจัดการ
                        <br>พื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดเชียงใหม่
                         <br>โดยองค์การบริหารส่วนจังหวัดเชียงใหม่ ร่วมกับมหาวิทยาลัยเชียงใหม่ </div>
                </td>
                <td width="15%">
            ...
            <div class="text4">1.2 ที่ตั้งพิกัดฝายที่ตรวจสอบ</div>
                <table style="padding-left:50px;">
                    <tr>
                        ...
                        <td width=25% class="line"><font class="outline">&nbsp;จังหวัด&nbsp;&nbsp;</font>&nbsp;&nbsp;เชียงใหม่</td>
                    </tr>
                </table>
