                                    ...
                                    <form class="wizard-form" id="basic-forms" action="{{route('form.formupdata')}}" enctype="multipart/form-data" method="POST" onsubmit="return confirm('บันทึกข้อมูล เรียบร้อย !!');">
                                        ...
                                        <fieldset>
                                          ...
                                          <!-- 1.6 พื้นที่รับประโยชน์ -->
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label ">1.6 พื้นที่รับประโยชน์</label>
                                                
                                                ด้านการเกษตร 
                                                <div class="col-sm-2">
                                                        <input id="agriculture" name="agriculture" type="text" class="form-control" placeholder="ไร่" value="{{$space[0]->agriculture}}">
                                                </div> 
