...
<html lang="en">
    ...
    <meta charset="utf-8">
    <meta name="asset-path" content="{{ url('/chiangmai/') }}">
    <!-- <meta name="asset-path" content="{{ url('weir/chiangmai/public/') }}"> -->
    <!-- <meta name="asset-path" content="https://watercenter.scmc.cmu.ac.th/weir/chiangmai/> -->
