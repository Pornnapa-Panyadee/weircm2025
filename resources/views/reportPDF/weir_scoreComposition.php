    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:60px;"> 
            <table align="center" class="customers" width="80%">
                ...
                <tr>
                    <td colspan="3" height=150px; class="customers"> <font style="font-size:50px;"><b><?php echo $text_amp ?>  จังหวัดเชียงใหม่</b></td>
                </tr>
                <tr>
                    <td colspan="3" class="customers"> <font style="font-size:32px;"><b>โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝาย <br>และการบริหารจัดการพื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดเชียงใหม่<b></td>
                </tr>
                <tr>
                    <td colspan="3" height=80px;> <font style="font-size:26px;"><b>โดย องค์การบริหารส่วนจังหวัดเชียงใหม่ ร่วมกับมหาวิทยาลัยเชียงใหม่<b></td>
            </table>
