    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:60px;"> 
            <table align="center" class="customers" width="80%">
                <tr >
                    <td width="30%" class="customers"><img src="images/footer/cm.png" width="100px"></td>
                ...
                <tr>
                    <td colspan="3" height=200px; class="customers"> <font style="font-size:60px;"><b><?php echo $text_tm ?> <br> <?php echo $text_amp ?> จังหวัดเชียงใหม่</b></td>
                </tr>
                <tr>
                    <td colspan="3" height=200px; class="customers"> <font style="font-size:28px;"><b>โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝาย<br>และการบริหารจัดการพื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดเชียงใหม่<b></td>
                </tr>
                <tr>
                    <td colspan="3" > <font style="font-size:22px;"><b>โดย องค์การบริหารส่วนจังหวัดเชียงใหม่ ร่วมกับมหาวิทยาลัยเชียงใหม่<b></td>
                </tr>
            </table>
                ...
                <div class="headname">
                    <table align="center">
                        <td width="15%" align="right" >
                            <img src='images/footer/cm.png' width="40px">
                        
                        </td>
                        <td width="70%">
                            <div class="texthead"> <b>การตรวจสภาพฝายและแนวทางแก้ไขปรับปรุงเพื่อเพิ่มประสิทธิภาพฝาย ในจังหวัดเชียงใหม่ </b></div>
                        </td>
                ...
                <div class="text06">
                    ...
                    <table style="text-align:left;">
                        <tr>
                            ...
                            <td width="15%"><b>จังหวัด </b> &nbsp;เชียงใหม่</td>
                            <td  >&nbsp;</td>
                        </tr>
                    </table>
                    <table style="text-align:left;">
