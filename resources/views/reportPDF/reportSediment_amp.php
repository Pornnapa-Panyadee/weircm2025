    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:60px;"> 
            <table align="center" class="customers" width="80%">
                ...
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:42px;"><b><?php echo($text_amp); ?>  จังหวัดเชียงใหม่</b></td>
                </tr>
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:32px;"><b>โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝายและ<br>การบริหารจัดการพื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดเชียงใหม่<b></td>
                </tr>
                <tr>
                    <td colspan="4" height=100px;> <font style="font-size:26px;"><b>โดย องค์การบริหารส่วนจังหวัดเชียงใหม่ ร่วมกับมหาวิทยาลัยเชียงใหม่<b></td>
                </tr>
            </table>
