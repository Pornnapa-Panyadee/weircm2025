    ...
    <body>
        <div class="row" align="center" style="page-break-after:always; margin-top:40px;"> 
            <table align="center" class="customers" width="80%">
                ...
                <tr>
                    <td colspan="4" height=200px; class="customers"> <font style="font-size:50px;"><b><?php echo $text_amp ?>  จังหวัดเชียงใหม่</b></td>
                </tr>
                <tr>
                    <td colspan="4" class="customers"> <font style="font-size:32px;"><b>โครงการพัฒนาระบบสารสนเทศการตรวจประเมินสภาพฝายและการบริหารจัดการพื้นที่เสี่ยงภัยแล้งและน้ำท่วมในจังหวัดเชียงใหม่<b></td>
                </tr>
                <tr>
